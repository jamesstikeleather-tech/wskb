...
import 'features/catalogs/views/razor_detail_page.dart';


import 'package:firebase_core/firebase_core.dart';
import 'firebase_options.dart'; // generated by flutterfire configure

import 'features/catalogs/views/razor_import_page.dart';
  ...
  routes: [
	...
	GoRoute(
 	  ...
 	  routes: [
   		 GoRoute(
     		 	 path: 'import',
      			builder: (ctx, st) => const RazorImportPage(),
   		 ),
    		 GoRoute(
     			 path: ':id',
     			 builder: (ctx, st) => RazorDetailPage(id: st.pathParameters['id']!),
   		 ),
  	],
       ),
